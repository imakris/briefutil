...
// language code's "en" fallback / language normalization) are NOT in the
// tables and stay open-coded at their respective call sites.
// ============================================================================
...
inline constexpr Sender_string_field k_sender_string_fields[] = {
    ...
    { "language",            "language",          &Sender_profile::language            },
