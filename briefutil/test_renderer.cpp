...
static const Color k_footer_col  = { 9.0f/255, 92.0f/255, 105.0f/255 };
...
int main(int argc, char* argv[])
{
    ...
    // Page 1: header elements + start of body
    {
        ...
        // Fold marks
        p.elements.push_back(Line_segment{ 0, 105, 10, 105, 0.5f, k_black });
        p.elements.push_back(Line_segment{ 0, 210, 10, 210, 0.5f, k_black });
        p.elements.push_back(Line_segment{ 0, 148.5f, 15, 148.5f, 0.5f, k_black });
        ...
        p.elements.push_back(Line_segment{
